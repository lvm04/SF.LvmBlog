    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        public class UserConfiguration : IEntityTypeConfiguration<User>
        {
            public void Configure(EntityTypeBuilder<User> builder)
            {
                builder.HasData(
                    ...
                    new User { Id = 5, Login = "tom", Name = "Томас", Password = "123", Email = "tom@mail.ru" },
                    new User { Id = 6, Login = "bob", Name = "Горохов Иван", Password = "123", Email = "bob@mail.ru" }
                );
        ...
        public class TagConfiguration : IEntityTypeConfiguration<Tag>
        {
            public void Configure(EntityTypeBuilder<Tag> builder)
            {
                ...
                var tag5 = new Tag { Id = 5, Name = "Биология" };
                var tag6 = new Tag { Id = 6, Name = "Путешествия" };
                var tag7 = new Tag { Id = 7, Name = "Политика" };
                builder.HasData(tag1, tag2, tag3, tag4, tag5, tag6, tag7);
            }
        }
